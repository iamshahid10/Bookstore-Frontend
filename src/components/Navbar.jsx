...
function Navbar() {
  ...
  const navItems = (
    <><li><a href='/'>Home</a></li>
      <li><Link to='/course'>All Books</Link></li>
      <li><a>Contact</a></li>
      <li><a>About</a></li></>
  );
  return (
    <>
      <div className={`max-w-full container mx-auto dark:bg-slate-900 dark:text-white md:px-20 px-4 fixed top-0 left-0 right-0 z-50 ${sticky ? "sticky-navbar shadow-md bg-base-200 duration-300 dark:bg-slate-600 dark:text-white transition-all ease-in-out" : ""} `}>
        <div className="navbar">
          ...
          <div className="navbar-end space-x-3">
            ...
            <div className="hidden md:block">
              <label className="input input-bordered px-3 py-2 border rounded-md flex items-center gap-2 dark:bg-slate-900">
            ...
            <div className="">
              ...
              <Login/>
              {  !authUser ?        <a className="bg-black text-white px-3 py-2 rounded-md hover:bg-slate-800 duration-300 cursor-pointer"
